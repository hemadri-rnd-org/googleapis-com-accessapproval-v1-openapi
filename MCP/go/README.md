# Access Approval API MCP Server

This MCP (Model Content Protocol) server provides access to Access Approval API API functionality through HTTP, HTTPS, and STDIO transport modes.
